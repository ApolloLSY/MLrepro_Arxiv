...
datafile = pd.read_table(
    "/data/LSY/z_preparing_and_parts/commontrait_Down/data_train.txt",
    index_col=0,
    header=0,
    delimiter="\t",
)
...
train_results.to_csv(
    "/data/LSY/z_preparing_and_parts/commontrait_Down/prediction_train.txt",
    sep="\t",
    index=False,
    mode="a",
)
...
train_scores.to_csv(
    "/data/LSY/z_preparing_and_parts/commontrait_Down/performance.txt",
    mode="a",
    index=True,
)
...
# save model
dump(logistic_model, "/data/LSY/z_preparing_and_parts/commontrait_Down/model.joblib")
dump(
    selected_features,
    "/data/LSY/z_preparing_and_parts/commontrait_Down/model_selected_features.joblib",
)
