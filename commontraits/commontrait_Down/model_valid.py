...
datafile = pd.read_table(
    "/data/LSY/z_preparing_and_parts/commontrait_Down/data_valid.txt",
    index_col=0,
    header=0,
    delimiter="\t",
)
...
loaded_model = load("/data/LSY/z_preparing_and_parts/commontrait_Down/model.joblib")
...
valid_results.to_csv(
    "/data/LSY/z_preparing_and_parts/commontrait_Down/prediction_valid.txt",
    sep="\t",
    index=False,
    mode="a",
)
