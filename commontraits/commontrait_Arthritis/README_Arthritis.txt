...
### folder notes:
train and test dataset matrix: GSE131989_series_matrix.txt | GSE121192_series_matrix.txt
validation dataset matrix: GSE111942_series_matrix.txt
...
# notes
For there is only one white blood cell dataset, monocytes were used, but the size is relatively small. This may affect performance.